...
Procedure SetToolbarActive()
  ...
  Else
    If CreateToolBar(0, WindowID(0))
        ...
        ToolBarSeparator()
        ; Operations > Style
        ToolBarImageButton(13,ImageID(LoadImage(#PB_Any,"..\img\0.ico")))
        ToolBarImageButton(14,ImageID(LoadImage(#PB_Any,"..\img\1.ico")))
        ToolBarImageButton(15,ImageID(LoadImage(#PB_Any,"..\img\2.ico")))
        ToolbarIcon_UnderlineDouble = LoadImage(#PB_Any,"..\img\22.png")
        ResizeImage(ToolbarIcon_UnderlineDouble,16,16,#PB_Image_Raw)
        ToolBarImageButton(30,ImageID(ToolbarIcon_UnderlineDouble))
        ToolBarImageButton(16,ImageID(LoadImage(#PB_Any,"..\img\3.ico")))
        ToolBarSeparator()
        ; Operations > Alignment
        ToolBarImageButton(17,ImageID(LoadImage(#PB_Any,"..\img\4.ico")))
        ToolBarImageButton(18,ImageID(LoadImage(#PB_Any,"..\img\5.ico")))
        ToolBarImageButton(19,ImageID(LoadImage(#PB_Any,"..\img\6.ico")))
        ToolBarImageButton(20,ImageID(LoadImage(#PB_Any,"..\img\7.ico")))
        ToolBarSeparator()
        ; Operations > Lists
        ToolBarImageButton(21,ImageID(LoadImage(#PB_Any,"..\img\8.ico")))
        ToolBarImageButton(22,ImageID(LoadImage(#PB_Any,"..\img\9.ico")))
        ToolBarImageButton(29,ImageID(LoadImage(#PB_Any,"..\img\16.ico")))
        ToolBarSeparator()
        ; Operations > Misc
        ToolBarImageButton(23,ImageID(LoadImage(#PB_Any,"..\img\10.ico")))
        ToolBarImageButton(24,ImageID(LoadImage(#PB_Any,"..\img\11.ico")))
        ToolBarImageButton(25,ImageID(LoadImage(#PB_Any,"..\img\12.ico")))
        ToolBarImageButton(26,ImageID(LoadImage(#PB_Any,"..\img\13.ico")))
        ToolbarIcon_31 = LoadImage(#PB_Any,"..\img\31.png")
        ResizeImage(ToolbarIcon_31,16,16,#PB_Image_Raw)
        ToolBarImageButton(31,ImageID(ToolbarIcon_31))
        ToolBarImageButton(27,ImageID(LoadImage(#PB_Any,"..\img\14.ico")))
        ToolBarSeparator()
        ToolBarImageButton(28,ImageID(LoadImage(#PB_Any,"..\img\15.ico")))
        ;}
        ;{ Tooltips
